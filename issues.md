...
- Tournament settings - Handicap Type: None, Rank Difference, Handicap modifier (None, Minus 1, Minus 2)
...
- SOS, SOSOS, SDS - calculations of these are fixed - go through player's opponents and add. No need to define custom weights to show a "total"
